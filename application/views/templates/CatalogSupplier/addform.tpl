{block name=centralContainer}
    <h1 class="page-header">{$data['title_supplier']}<small>{$data['add_label']}</small></h1>
    <div id="msgconfirm" class="alert hidden" role="alert">
        <p></p>
        <a href="{$base_url}/index.php/CatalogSupplier" class="alert-link">{$data['return']}</a>
    </div>
    <form id="supplierform" action='{$base_url}/index.php/CatalogSupplier/addConfirmation'>
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control" id="rfc" name="rfc" placeholder="{$data['rfc_label']}">
        </div>
