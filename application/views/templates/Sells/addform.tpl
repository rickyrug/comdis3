{block name=centralContainer}
    ...
    <form id="sellsform" action='{$base_url}/index.php/Sells/addConfirmation'>
        ...
        <div class="form-group ">
            ...
            <input  type="text" class="form-control " id="delverydate" name="delverydate" placeholder="{$data['deliverydate_label']}" value="{$today|date_format:"%Y-%m-%d"}">
        </div>
        <div class="form-group ">
            <label for="tax">{$data['tax_label']}</label>
            <div class="input-group">
                <input  type="text" class="form-control " id="tax" name="tax" placeholder="{$data['tax_label']}" value="{$tax}">
        ...
        <div class="form-group ">
            ...
            <div class="input-group">
                <input  type="text" class="form-control " id="discount" name="discount" placeholder="{$data['discount_label']}" value="{$discount}">
                <div class="input-group-addon">%</div>
            </div>
